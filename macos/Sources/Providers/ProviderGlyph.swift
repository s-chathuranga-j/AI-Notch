...
enum ProviderGlyph: String, Codable, Equatable {
    ...
    var opticalScale: CGFloat {
        ...
        // The face fills its box edge to edge, and its lower half is solid
        // ink; a touch smaller keeps it from outweighing the knots beside it.
        case .copilot: return 0.92
